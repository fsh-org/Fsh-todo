...
function reload() {
  ...
  g('preview').innerHTML = data.map(r => `<div class="card" id="c-${r.id}"${!!document.getElementById(r.id) ? '' : ' style="animation-name: appear;animation-duration: 1s;animation-iteration-count: 1;"'}>
